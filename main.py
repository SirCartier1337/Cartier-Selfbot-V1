...
async def help(ctx):
  ...
  try:
      ...
      embed.set_author(name="𝘾𝙖𝙧𝙩𝙞𝙚𝙧 𝙎𝙚𝙡𝙛𝙗𝙤𝙩",icon_url=ctx.author.avatar_url)
      embed.set_footer(text="Cartier SelfBot")
      embed.set_thumbnail(url=ctx.author.avatar_url)
      embed.set_image(url="https://cdn.discordapp.com/attachments/829181685991342140/831699441429119057/image0.gif")
      ...
      await ctx.send("""**__Cartier SelfBot Help__**\n
**Moderation**
...
async def moderation(ctx):
  ...
  try:
      ...
      embed.set_image(url="https://cdn.discordapp.com/attachments/823051201192919136/831188629333344286/nbayoungman.gif")
      await ctx.send(embed=embed)
  except:
      await ctx.send("""**__Cartier SelfBot Moderation__**\n
...
async def status(ctx):
  ...
  try:
      ...
      embed.set_thumbnail(url=ctx.author.avatar_url)
      embed.set_image(url="https://cdn.discordapp.com/attachments/823051201192919136/831270357763751956/rondo2.gif")
      ...
      await ctx.send("""**__Cartier SelfBot Status__**\n
[] Is Required, <> Is Optional*
...
async def utility(ctx):
  ...
  try:
      ...
      embed.set_image(url="https://cdn.discordapp.com/attachments/823051201192919136/831269766232145930/quando.gif")
      ...
      await ctx.send("""**__Cartier SelfBot Utility__**\n
*[] Is Required, <> Is Optional*
...
async def miscellaneous(ctx):
  ...
  try:
      ...
      embed.set_thumbnail(url=ctx.author.avatar_url)
      embed.set_image(url="https://cdn.discordapp.com/attachments/823051201192919136/831269063257751633/lilbaby.gif")
      ...
      await ctx.send("""**__Cartier SelfBot Miscellaneous__**\n
*[] Is Required, <> Is Optional*
...
async def nsfw(ctx):
  ...
  try:
      ...
      embed.set_footer(text="Cartier SelfBot")
      embed.set_thumbnail(url=ctx.author.avatar_url)
      embed.set_image(url="https://cdn.discordapp.com/attachments/823051201192919136/831730772250722324/giphy-downsized.gif")
      ...
      await ctx.send("""**__Cartier SelfBot NSFW__**\n
*[] Is Required, <> Is Optional*
...
async def nuke(ctx):
    ...
    try:
        ...
        embed.set_footer(text="Cartier SelfBot")
        embed.set_thumbnail(url=ctx.author.avatar_url)
        embed.set_image(url="https://cdn.discordapp.com/attachments/823051201192919136/831730081537196072/lilherb.gif")
        ...
        await ctx.send("""**__Cartier SelfBot Nuke__**\n
*[] Is Required, <> Is Optional*
...
async def math(ctx):
    ...
    try:
        ...
        embed.set_footer(text="Cartier SelfBot")
        embed.set_thumbnail(url=ctx.author.avatar_url)
        embed.set_image(url="https://cdn.discordapp.com/attachments/823051201192919136/831729676375949363/cartierfucker.gif")
        ...
        await ctx.send("""**__Cartier SelfBot Math__**\n
*[] Is Required, <> Is Optional*
...
async def server(ctx):
    ...
    try:
        ...
        embed.set_footer(text="Cartier SelfBot")
        embed.set_thumbnail(url=ctx.author.avatar_url)
        embed.set_image(url="https://cdn.discordapp.com/attachments/823051201192919136/831730518365437952/f9dc7f72bc9a1f039410755aca3306ed.gif")
        ...
        await ctx.send("""**__Cartier SelfBot Server__**\n
*[] Is Required, <> Is Optional*
...
async def personal(ctx):
    ...
    try:
        ...
        embed.set_footer(text="Cartier SelfBot")
        embed.set_thumbnail(url=ctx.author.avatar_url)
        embed.set_image(url="https://cdn.discordapp.com/attachments/823051201192919136/831728923683061760/6666624671237135865-1499067990.gif")
        ...
        await ctx.send("""**__Cartier SelfBot Personal__**\n
*[] Is Required, <> Is Optional*
...
async def creator(ctx):
  await ctx.message.delete()
  try:
      embed = discord.Embed(color=discord.Colour.from_rgb(255,0,0),title="Creator!",description="Cartier, <@796220560534798357>")
      await ctx.send(embed=embed)
  except:
      await ctx.send("""**__Creator__**\n\nCartier, <@796220560534798357>""")
